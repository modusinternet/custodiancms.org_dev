...
<header style="opacity:0">
	...
	<div id="user_dropdown">
		<button id="user_dropdown_btn">
			<svg class="dropbtn" style="width:50px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M15 11h7v2h-7zm1 4h6v2h-6zm-2-8h8v2h-8zM4 19h10v-1c0-2.757-2.243-5-5-5H7c-2.757 0-5 2.243-5 5v1h2zm4-7c1.995 0 3.5-1.505 3.5-3.5S9.995 5 8 5 4.5 6.505 4.5 8.5 6.005 12 8 12z"></path></svg>
		</button>
		<div id="user_dropdown_list" class="dropdown-content">
			<a href="/{CCMS_LIB:_default.php;FUNC:ccms_lng}/user/user_profile/" id="nav-user_profile">
				<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="#6563ff" d="M12,2A10,10,0,0,0,4.65,18.76h0a10,10,0,0,0,14.7,0h0A10,10,0,0,0,12,2Zm0,18a8,8,0,0,1-5.55-2.25,6,6,0,0,1,11.1,0A8,8,0,0,1,12,20ZM10,10a2,2,0,1,1,2,2A2,2,0,0,1,10,10Zm8.91,6A8,8,0,0,0,15,12.62a4,4,0,1,0-6,0A8,8,0,0,0,5.09,16,7.92,7.92,0,0,1,4,12a8,8,0,0,1,16,0A7.92,7.92,0,0,1,18.91,16Z"/></svg>
				<!-- Icon provided 'royalty-free for commercial use' by https://iconscout.com/free-icons -->
				User Profile</a>
			<a href="/{CCMS_LIB:_default.php;FUNC:ccms_lng}/?ccms_token=<?= md5(time());?>">
				<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="#6563ff" d="M21.66,10.25l-9-8a1,1,0,0,0-1.32,0l-9,8a1,1,0,0,0-.27,1.11A1,1,0,0,0,3,12H4v9a1,1,0,0,0,1,1H19a1,1,0,0,0,1-1V12h1a1,1,0,0,0,.93-.64A1,1,0,0,0,21.66,10.25ZM13,20H11V17a1,1,0,0,1,2,0Zm5,0H15V17a3,3,0,0,0-6,0v3H6V12H18ZM5.63,10,12,4.34,18.37,10Z"/></svg>
				<!-- Icon provided 'royalty-free for commercial use' by https://iconscout.com/free-icons -->
				Back to Home</a>
			<a href="/{CCMS_LIB:_default.php;FUNC:ccms_lng}/user/?ccms_logout=1" style="border-top:1px solid var(--cl0)">
				<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="#6563ff" d="M4,12a1,1,0,0,0,1,1h7.59l-2.3,2.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0l4-4a1,1,0,0,0,.21-.33,1,1,0,0,0,0-.76,1,1,0,0,0-.21-.33l-4-4a1,1,0,1,0-1.42,1.42L12.59,11H5A1,1,0,0,0,4,12ZM17,2H7A3,3,0,0,0,4,5V8A1,1,0,0,0,6,8V5A1,1,0,0,1,7,4H17a1,1,0,0,1,1,1V19a1,1,0,0,1-1,1H7a1,1,0,0,1-1-1V16a1,1,0,0,0-2,0v3a3,3,0,0,0,3,3H17a3,3,0,0,0,3-3V5A3,3,0,0,0,17,2Z"/></svg>
				<!-- Icon provided 'royalty-free for commercial use' by https://iconscout.com/free-icons -->
				Logout</a>
		</div>
	</div>
...
<nav class="sidebar-nav" id="menu-cnt">
	<ul class="metismenu" id="menu1">
		<li id="nav-dashboard">
			<a href="/{CCMS_LIB:_default.php;FUNC:ccms_lng}/user/dashboard/">
				<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="#6563ff" d="M10,13H4a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h6a1,1,0,0,0,1-1V14A1,1,0,0,0,10,13ZM9,19H5V15H9ZM20,3H14a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h6a1,1,0,0,0,1-1V4A1,1,0,0,0,20,3ZM19,9H15V5h4Zm1,7H18V14a1,1,0,0,0-2,0v2H14a1,1,0,0,0,0,2h2v2a1,1,0,0,0,2,0V18h2a1,1,0,0,0,0-2ZM10,3H4A1,1,0,0,0,3,4v6a1,1,0,0,0,1,1h6a1,1,0,0,0,1-1V4A1,1,0,0,0,10,3ZM9,9H5V5H9Z"/></svg>
				<!-- Icon provided 'royalty-free for commercial use' by https://iconscout.com/free-icons -->
				Dashboard
			</a>
		</li>
				...
				<li id="nav-admin-backup">
					<a href="/{CCMS_LIB:_default.php;FUNC:ccms_lng}/user/admin/backup/">
						...
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
							...
							<path d="M20.88 18.09A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.29" style="fill:none"></path>
						</svg>
