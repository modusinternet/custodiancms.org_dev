...
<style>
	...
	@media only screen and (min-width:435px){
		.ccms_msg{max-width:400px}

		.ccms_msg.active.error{max-width:80%}

		.ccms_msg.active.success{max-width:400px}
	}
	...
	@media only screen and (min-width:600px){
		...
		.ccms_msg.active.error{max-width:70%}
	...
	@media only screen and (min-width:950px){
		...
		.ccms_msg.active.error{max-width:60%}
	...
	@media only screen and (min-width:1400px){
		...
		.ccms_msg.active.error{max-width:50%}
